...
public final class FileUtils {
    ...
    public static int getClosestParent(
    ...
    public static int getDepth(String parent, String child) {
        ...
        if (!isSubOf(parent, child)) throw new IllegalArgumentException(
            "parent is not parent of child"
        );

        return Math.abs(
            StringUtils.countOf(parent, '/') - StringUtils.countOf(child, '/')
        );
    }
}
