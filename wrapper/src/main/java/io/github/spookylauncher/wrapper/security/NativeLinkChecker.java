...
public final class NativeLinkChecker extends Checker {
    ...
    public NativeLinkChecker(
        Set<String> librariesNames,
        Set<File> librariesFiles
    ) {
    ...
    public NativeLinkChecker(
        ...
        super(mode);
        this.librariesNames = Collections.unmodifiableSet(
            new LinkedHashSet<>(librariesNames)
        );
        this.librariesFiles = Collections.unmodifiableSet(
            new LinkedHashSet<>(librariesFiles)
        );
    }
