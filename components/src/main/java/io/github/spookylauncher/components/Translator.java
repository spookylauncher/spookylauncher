...
public final class Translator extends LauncherComponent {
    ...
    public void reloadLocale() {
        ...
        String localeResource =
            "locales/" +
            components.get(OptionsController.class).getOptions().locale +
            ".properties";

        if (!Resource.exists(localeResource)) localeResource =
            "locales/fallback.properties";
        ...
        try {
            ...
            LOG.logp(
                Level.SEVERE,
                "io.github.spookylauncher.components.Translator",
                "reloadLocale",
                "Throw!",
                e
            );
            components
                ...
                .handleException("Failed to load locale", e);
        }
