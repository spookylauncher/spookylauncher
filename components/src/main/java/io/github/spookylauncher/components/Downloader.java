...
public final class Downloader extends LauncherComponent {
    ...
    public void download(
        ...
        synchronized (Downloader.class) {
            ...
            LOG.info(
                "starting downloading of some resource to \"" +
                    destination.getAbsolutePath() +
                    "\""
            );

            try {
                InstallAdapter adapter = createInstallAdapter(
                    destination,
                    options,
                    canceled
                );
                ...
                if (adapter != null) {
                    ...
                    executor.execute(() -> {
                        try {
                            ...
                            LOG.logp(
                                Level.SEVERE,
                                "io.github.spookylauncher.components.Downloader",
                                "download",
                                "THROW",
                                e
                            );
                ...
                components
                    ...
                    .handleException("installationError", e);
            }
        }
    }

    public void downloadAndUnpackZip(
        File destination,
        Collector collector,
        Options options,
        Consumer<Boolean> onInstalled
        ...
        synchronized (Downloader.class) {
            ...
            LOG.info(
                "starting downloading and unpacking some resource to \"" +
                    destination.getAbsolutePath() +
                    "\""
            );
    ...
    private InstallAdapter createInstallAdapter(
        File destination,
        Options options,
