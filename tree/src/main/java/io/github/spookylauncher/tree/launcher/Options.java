...
public final class Options {
    ...
    @SerializedName("discordPresence")
    public boolean discordPresence = true;

    @SerializedName("selectedJavaType")
    public SelectedJavaType selectedJavaType = SelectedJavaType.EXTERNAL;

    @SerializedName("selectedJava")
    public String selectedJava;

    @SerializedName("customJavaPath")
    public String customJavaPath;

    @SerializedName("selectedJavaPath")
