...
public class SettingsDialog extends JDialog {
    ...
    public SettingsDialog(
        ...
        ramSlider.addChangeListener((ChangeEvent e) -> {
            if (!ramFocused) ramField.setText(
                String.valueOf(ramSlider.getValue())
            );
        });
        ...
        jreSettingsButton.addActionListener(e -> {
    ...
    private void $$$setupUI$$$() {
        ...
        contentPane.setLayout(
            new GridLayoutManager(3, 1, new Insets(10, 10, 10, 10), -1, -1)
        );
