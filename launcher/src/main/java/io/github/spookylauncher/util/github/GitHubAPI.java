...
public final class GitHubAPI {
    public static Tree getTreeFromBranch(String user, String repo, String path) {
        return getTreeFromBranch(user, repo, "main", path);
    }

    public static Tree getTreeFromBranch(String user, String repo, String branch, String path) {
    ...
    public static Tree getTree(String user, String repo, String tree) {
