...
public final class PipedPrintStream extends PrintStream {
    ...
    private static OutputStream nullStream() {
    ...
    public void print(final String x) {
        for (PrintStream printer : this.printers) printer.print(x);
    }
    ...
    public void println(final String x) {
        for (PrintStream printer : this.printers) printer.println(x);
    }
    ...
    @Override
    public void println() {
        for (PrintStream printer : this.printers) printer.println();
    }

    @Override
    public PrintStream printf(final String format, final Object... args) {
        for (PrintStream printer : this.printers) printer.printf(format, args);
        return this;
    }
    ...
    public PrintStream printf(
        ...
        for (PrintStream printer : this.printers)
            printer.printf(locale, format, args);
        return this;
    }
}
